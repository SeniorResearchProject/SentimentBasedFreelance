"""
Django settings for SentimentService project.
...
SECRET_KEY = "django-insecure-qr2=0+z+kas&=8-%0q_@clz*7nn@5fgo1a=4+$9+ztglqdncva"
...
ROOT_URLCONF = "SentimentService.urls"
...
WSGI_APPLICATION = "SentimentService.wsgi.application"
