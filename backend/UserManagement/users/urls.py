...
from . import views
from .views import RegisterView, LoginView,  LogoutView, AllUsersView, UpdateUserView, DeleteUserView, ValidateTokenView,  VerifyEmail, PasswordTokenCheckAPI, RequestPasswordResetEmail, SetNewPasswordView
